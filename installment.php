            ...
            <div class="installment-info">
                <?php foreach ($installments as $installment): ?>
                    <div>
                        ...
                        <strong>Laptop Configuration:</strong> <span><?php echo htmlspecialchars($installment['laptop_configuration']); ?></span><br>
                        <strong>Amount:</strong> <span><?php echo htmlspecialchars($payment_history[0]['amount'] ?? 'N/A'); ?></span><br>
                        <strong>Remaining Amount:</strong> <span><?php echo htmlspecialchars($payment_history[0]['remaining_amount'] ?? 'N/A'); ?></span>
                    </div>
                <?php endforeach; ?>
            </div>
